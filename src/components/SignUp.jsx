    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-[var(--bg-primary)] relative overflow-hidden">
      ...
      <div className="w-full max-w-md animate-fadeIn relative z-10">
        <div className="text-center mb-10">
          <div className="inline-block p-4 rounded-3xl bg-indigo-500/10 mb-6 border border-indigo-500/20">
        ...
        <Card padding={true} className="border border-[var(--border-color)] shadow-2xl backdrop-blur-xl bg-[var(--bg-secondary)]/60 relative overflow-hidden group">
          ...
          <div className="mb-8 flex items-center justify-between">
            ...
            <div className="text-[9px] font-black text-indigo-500 uppercase tracking-widest opacity-50">Create Identity</div>
          </div>
          ...
          <Button 
            ...
            variant="secondary" 
            className="w-full py-4 flex items-center justify-center gap-3 border-[var(--border-color)] hover:border-indigo-500/50 transition-all mb-8 bg-indigo-500/5 hover:bg-indigo-500/10 group/btn"
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-black text-[10px] uppercase tracking-[0.2em] group-hover/btn:tracking-[0.25em] transition-all text-[var(--text-primary)]">Sign up with Google</span>
            </div>
          </Button>
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-[9px] uppercase tracking-[0.3em] font-black">
              <span className="px-4 bg-[var(--bg-secondary)] text-[var(--text-tertiary)] rounded-full">Or register email</span>
            </div>
          </div>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-[9px] font-black uppercase tracking-[0.3em] mb-2 px-1 text-[var(--text-secondary)]">Full Name</label>
              <input
                type="text"
                value={formData.name}
                onChange={(e) => setFormData({...formData, name: e.target.value})}
                className="w-full bg-[var(--bg-tertiary)]/50 border border-[var(--border-color)] rounded-2xl px-5 py-4 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500/50 transition-all text-[var(--text-primary)] font-bold text-sm tracking-tight"
            ...
            <Button type="submit" variant="primary" className="w-full py-5 text-[11px] font-black uppercase tracking-[0.3em] bg-gradient-to-r from-indigo-600 to-purple-600 border-none mt-6 shadow-xl shadow-indigo-500/20 hover:scale-[1.02] active:scale-[0.98]">Join Ecosystem</Button>
          </form>
          ...
          <div className="mt-10 pt-8 border-t border-[var(--border-color)] text-center">
            <p className="text-[10px] font-black uppercase tracking-widest opacity-70" style={{ color: 'var(--text-secondary)' }}>
              Already registered? <Link to="/login" className="text-indigo-500 font-black hover:text-indigo-600 transition-colors">Sign In</Link>
            </p>
          </div>
        </Card>
      </div>
