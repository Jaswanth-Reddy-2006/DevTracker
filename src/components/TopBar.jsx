    ...
    >
      <div className="flex items-center gap-6">
        <div className="flex flex-col">
          <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-500 mb-0.5 animate-pulse">Network_Node</span>
          <div className="flex items-center gap-2">
            <span className="text-sm font-black text-[var(--text-primary)] uppercase tracking-tighter">Terminal_01.exe</span>
            <div className="px-1.5 py-0.5 rounded bg-blue-500/10 border border-blue-500/20">
              <span className="text-[8px] font-black text-blue-500 tabular-nums">ID: {Math.floor(Math.random() * 9000) + 1000}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-6">
        <button 
          onClick={toggleTheme}
          className="p-3 rounded-2xl bg-[var(--bg-tertiary)] border border-[var(--border-color)] text-[var(--text-primary)] hover:border-blue-500/50 transition-all shadow-sm group"
        >
          {theme === 'light' ? (
        ...
        <div className="hidden md:flex items-center gap-4 pl-6 border-l border-[var(--border-color)]">
          <div className="flex flex-col items-end">
            <span className="text-[10px] font-black uppercase tracking-widest text-[var(--text-tertiary)] mb-0.5">Efficiency_Index</span>
            <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-4 pl-6 border-l border-[var(--border-color)]">
          <div className="text-right hidden sm:block">
            ...
            <div className="text-[10px] font-black uppercase tracking-widest text-green-500 flex items-center justify-end gap-1.5">
