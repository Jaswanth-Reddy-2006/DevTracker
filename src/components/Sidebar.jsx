  ...
  return (
    ...
    >
      ...
      <div className="p-6 relative z-10">
        <div className="rounded-2xl p-6 bg-[var(--bg-tertiary)]/50 border border-[var(--border-color)] text-[var(--text-primary)] shadow-sm relative overflow-hidden group">
          ...
          <div className="relative z-10">
            <p className="text-[9px] font-black uppercase tracking-[0.3em] mb-3 text-blue-500">System Status</p>
            <div className="space-y-3">
              ...
              <div className="flex justify-between items-center">
                <span className="text-[9px] font-bold uppercase tracking-widest text-[var(--text-tertiary)]">Platform</span>
